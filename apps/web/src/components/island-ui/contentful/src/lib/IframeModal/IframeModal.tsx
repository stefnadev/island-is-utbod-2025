...
import { Box, Icon, Text } from '../../../../core/src';
import {
  useDialogState,
  Dialog,
  DialogDisclosure,
...
IframeModalDiv.displayName = 'IframeModalDiv';
    ...
    <>
      {!!disclosure && (
        <DialogDisclosure {...dialog} {...(disclosure.props as any)}>
          {(
            disclosureProps: (Partial<unknown> & React.Attributes) | undefined,
